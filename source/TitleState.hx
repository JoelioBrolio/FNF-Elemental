		...
		if(!closedState) {
			switch (curBeat)
			{
				...
				case 12:
					deleteCoolText();
				// credTextShit.visible = false;
				// credTextShit.text = "Ascendante";
				// credTextShit.screenCenter();
				case 13:
					addMoreText('Ascendante');
				// credTextShit.visible = true;
				case 14:
					addMoreText('Scorpzie');
				// credTextShit.visible = true;
				case 15:
					addMoreText('dasher');
				// credTextShit.text += '\ndasher';
				case 16:
					addMoreText('JoelioBrolio');
				// credTextShit.text += '\nJoelioBrolio';
				case 17:
					addMoreText('Kreagato');
				// credTextShit.text += '\nKreagato';
				case 18:
					addMoreText('12kNoodles');
				// credTextShit.text += '\n12kNoodles';
				case 19:
					addMoreText('thevoiceboilol');
				// credTextShit.text += '\nthevoiceboilol';
				case 20:
					deleteCoolText();
				// credTextShit.visible = false;
				...
				case 23:
					...
					// credTextShit.text += '\nFunkin';
				case 24:
					addMoreText('Elemental'); // credTextShit.text += '\nElemental';
